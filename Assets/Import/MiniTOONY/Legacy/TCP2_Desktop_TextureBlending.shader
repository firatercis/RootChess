...
Shader "Toony Colors Pro 2/Legacy/DesktopModified"
{
	Properties
	{
		//TOONY COLORS
		...
		_DryVersionTex("Dry Version Texture (RGB) Spec/Refl Mask (A) ", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf (Input IN, inout SurfaceOutput o)
		{
			...
			half4 c2 = tex2D(_DryVersionTex, IN.uv_MainTex);
			o.Albedo = (c.rgb * (1-_Blending) + c2.rgb * (_Blending) ) * _Color.rgb;
